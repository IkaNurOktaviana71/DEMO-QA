...
WebUI.setText(findTestObject('Text Box/input_Email_userEmail'), email)

WebUI.setText(findTestObject('Text Box/textarea_Current Address_currentAddress'), cur)

WebUI.setText(findTestObject('Text Box/textarea_Permanent Address_permanentAddress'), per)

WebUI.scrollToElement(findTestObject('Text Box/button_Submit'), 0)

WebUI.click(findTestObject('Text Box/button_Submit'))

WebUI.verifyTextPresent('Please input an valid field.', false)
